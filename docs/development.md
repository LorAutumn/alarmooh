# alarmooh – Entwicklung und Hintergründe

Diese Seite sammelt die Details, die in der [README](../README.md) nur verlinkt sind: wie die App gebaut und signiert wird, warum die Hardened Runtime eine Kalender-Berechtigung braucht, welche Dateien sie anlegt, wie das Projekt aufgebaut ist und wo ihre Grenzen liegen. Die Gründe hinter den Entscheidungen stehen im [Design-Dokument](plans/2026-08-06-alarmooh-design.md).
...
Grenzen" von [`docs/plans/2026-08-06-alarmooh-design.md`](plans/2026-08-06-alarmooh-design.md).
